...
cat <<'EOF'
 _    _ _                   _____          _        _ _           
| |  | (_)                 |_   _|        | |      | | |          
| |  | |_ _ __   __ _ ___    | | _ __  ___| |_ __ _| | | ___ _ __ 
| |/\| | | '_ \ / _` / __|   | || '_ \/ __| __/ _` | | |/ _ \ '__|
\  /\  / | | | | (_| \__ \  _| || | | \__ \ || (_| | | |  __/ |   
 \/  \/|_|_| |_|\__, |___/  \___/_| |_|___/\__\__,_|_|_|\___|_|   
                 __/ |                                            
                |___/                                             
EOF
...
echo "Jika inggin dokumentasi resmi Pterodactyl: https://pterodactyl.io"
...
echo "Username login panel: (yang tadi dibuat)"
echo "Password login panel: (yang tadi dibuat)"
echo "Pastikan untuk reboot server agar semua service berjalan normal"
